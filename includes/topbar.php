...
<header class="dash-topbar">
    ...
    <div class="dash-topbar-right">
        <button style="background:transparent; border:none; position:relative; color:var(--dash-text-muted); cursor:pointer;">
            ...
            <span style="position:absolute; top:0; right:2px; width:8px; height:8px; background:var(--dash-warning); border-radius:50%; border:2px solid var(--dash-bg);"></span>
        </button>
        ...
        <script>
            ...
            document.addEventListener('click', function(event) {
                var isClickInside = document.querySelector('.profile-dropdown-wrapper').contains(event.target);
                if (!isClickInside) {
            ...
            // Override toggle logic to handle inline style
