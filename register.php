...
$stmt = $pdo->prepare("SELECT setting_key, setting_value FROM settings WHERE setting_key IN ('enable_registration_google', 'enable_registration_manual')");
$stmt->execute();
        ...
        <div class="register-container">
            ...
            <div class="register-right">
                ...
                <?php else: ?>
                    <?php if ($enable_google === '1'): ?>
                    <div style="background: rgba(239, 68, 68, 0.1); color: #ef4444; padding: 1rem; border-radius: 12px; margin-bottom: 1.5rem; text-align: center; font-weight: 600; width: 100%;">
                        Pendaftaran secara manual saat ini sedang ditutup.
                    </div>
                    <?php endif; ?>
                <?php endif; ?>
                ...
                <?php else: ?>
                    <?php if ($enable_manual !== '1'): ?>
                    <div style="background: rgba(239, 68, 68, 0.1); color: #ef4444; padding: 1rem; border-radius: 12px; margin-bottom: 1.5rem; text-align: center; font-weight: 600; width: 100%;">
                        Pendaftaran baru (Manual & Google) saat ini sedang ditutup.
                    </div>
                    <?php else: ?>
                    <div style="color: var(--text-muted); font-size: 0.85rem; text-align: center; margin-top: 1rem;">
                        Pendaftaran via Google ditutup.
                    </div>
                    <?php endif; ?>
                <?php endif; ?>
